...
def manual_update_notice():
    ...
    for f in ["TeXworks.ini", "README.md", "res/texworks.appdata.xml", "res/texworks.1", ".github/actions/package-launchpad/launchpad/debian/copyright", "win32/README.win.txt", "CMake/Modules/COPYING-CMAKE-MODULES"]:
    	print("   {0}".format(f))
