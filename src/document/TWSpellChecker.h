...
*/
#ifndef Tw_Document_SpellChecker_H
#define Tw_Document_SpellChecker_H
...
namespace Document {
namespace UnitTest {
class SpellCheckerTest; // This class may exist uniquely while testing, friend of everyone.
}
...
public:
    class Dictionary {
        ...
        QString language_m;
        Hunhandle * hunhandle_m;
        QTextCodec * codec_m;
        
        Dictionary(const QString & language, Hunhandle * hunhandle);
    public:
        virtual ~Dictionary();
        QString getLanguage() const { return language_m; }
        ...
        friend class UnitTest::SpellCheckerTest;
    };
    
    static SpellChecker * instance() { return instance_m; }
    
    using DictionaryList = QMultiHash<QString, QString>;
    // get list of available dictionaries
    static DictionaryList * getDictionaryList(const bool forceReload = false);
...
private:
    static SpellChecker * instance_m;
...
#endif // !defined(Tw_Document_SpellChecker_H)
