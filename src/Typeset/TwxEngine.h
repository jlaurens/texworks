...
public:
  typedef QList<Engine> List;
	 ...
	 */
	int add(int a, int b);  static const List& factoryEngineList();
	 ...
	 *  \param parent an optional owner
	 */
	QProcess* run(const QFileInfo& input, QObject* parent = nullptr) const;
