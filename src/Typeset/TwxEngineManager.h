 ...
 *  clients may store the engine name instead of the engine.
 * 
...
public:
  ...
  static EngineManager *emitter();
	 ...
	 */
	static const Engine::List getEngineList();

	/*! \brief Set the current list of engines
	 *  \param engines possibly void list of engines.
	 *  \return false if the list contains duplicates, false otherwise
	 */
  static bool setEngineList(const Engine::List& engines);
	 ...
	 */
	static const Engine getEngineWithName(const QString& name);

	/*! \brief Get the default engine name.
	 *  \return a non empty `QString`.
	 */
	static const QString getDefaultEngineName();

	/*! \brief Set the default engine name.
	 *  \param a non empty `QString`.
	 */
	static void setDefaultEngineName(const QString& name);

	/*! \brief Get the default engine.
	 *  \return the engine with name `getDefaultEngineName()`.
	 */
	static const Engine getDefaultEngine();
...
#include "TwxEngineManagerPrivate.h"
