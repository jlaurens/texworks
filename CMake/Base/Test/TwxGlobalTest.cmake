...
message ( STATUS "twx_global_init/1" )
block ()
list ( APPEND CMAKE_MESSAGE_CONTEXT init/1 )
twx_test_fatal_assert_passed()
if ( TRUE )
  unset ( TWX_GLOBAL_TREE/ )
  twx_global_restore ()s
  twx_tree_assert ( TWX_GLOBAL_TREE/ )
  twx_assert_true ( "${TWX_IS_TREE_TWX_GLOBAL_TREE/}" )
endif ()
twx_test_fatal_assert_passed()
endblock ()
...
if ( TRUE )
  ...
  twx_expect ( A/ "${TWX_TREE_HEADER}${TWX_TREE_GROUP_SEP}key${TWX_TREE_RECORD_SEP}value" )
  set ( A.key dummy )
