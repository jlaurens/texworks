...
twx_test_unit_will_begin ( NAME "twx_tree_prettify" )
...
twx_test_unit_will_begin ( NAME "TWX_TREE_KEY_RE" ID KEY_RE )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_fatal_test ()
  # set (
...
twx_test_unit_will_begin ( NAME "twx_tree_assert_key" ID assert_key )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_fatal_test ()
...
twx_test_unit_will_begin ( NAME "twx_tree_init/1" ID init/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  unset ( A/ )
  twx_tree_init ( A/ )
...
twx_test_unit_will_begin ( NAME "twx_tree_init(1-2)" ID init/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  set ( A/ dummy )
  twx_tree_init ( A/ )
...
twx_test_unit_will_begin ( NAME "twx_tree_get_keys/1" ID get_keys/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
twx_test_unit_will_begin ( NAME "twx_tree_get/1" ID get/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_fatal_test ()
  twx_tree_assert ( A/ )
...
twx_test_unit_will_begin ( NAME "twx_tree_set/1" ID set/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  unset ( A/ )
  twx_tree_init ( A/ )
...
twx_test_unit_will_begin ( NAME "twx_tree_set/2" ID set/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  unset ( A/ )
  twx_tree_init ( A/ )
...
twx_test_unit_will_begin ( NAME "twx_tree_set/remove/1" ID set/remove/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key=value )
...
twx_test_unit_will_begin ( NAME "twx_tree_set/3" ID set/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key=value )
...
twx_test_unit_will_begin ( NAME "twx_tree_set/get/1" ID set/get/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key=value )
...
twx_test_unit_will_begin ( NAME "twx_tree_set/get/2" ID set/get/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
...
twx_test_unit_will_begin ( NAME "twx_tree_set/get/3" ID set/get/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ k/kk/kkk=value )
...
twx_test_unit_will_begin ( NAME "twx_tree_remove/1" )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
twx_test_unit_will_begin ( NAME "twx_tree_remove/2" )
if ( TWX_TEST_UNIT_RUN )
  block ()
  # Remove value
  twx_tree_init ( A/ )
...
twx_test_unit_will_begin ( NAME "twx_tree_remove/3" ID remove/3 )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
twx_test_unit_will_begin ( NAME "twx_tree_remove/4" ID remove/4 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key/key/key=value )
...
twx_test_unit_will_begin ( NAME "twx_tree_remove/5" ID remove/5 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key/key/key=value )
...
twx_test_unit_will_begin ( NAME "twx_tree_..." )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_expect ( A/ "${TWX_TREE_HEADER}" )
...
twx_test_unit_will_begin ( NAME "Trees inside trees" ID subtrees )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_init ( AA/ )
...
twx_test_unit_will_begin ( NAME "Tree with default Tree" ID TWX_TREE )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
...
twx_test_unit_will_begin ( NAME "twx_tree_get" ID get )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  set ( v dummy )
...
twx_test_unit_will_begin ( NAME "twx_tree_set" ID set )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
...
twx_test_unit_will_begin ( NAME "twx_tree_remove_one" ID remove )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
...
twx_test_unit_will_begin ( NAME "twx_tree_remove" ID remove )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
...
twx_test_unit_will_begin ( NAME "twx_tree_remove(2)" ID remove )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k/kk=v )
...
twx_test_unit_will_begin ( NAME "twx_tree_remove(3)" ID remove )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k/kk=v )
...
twx_test_unit_will_begin ( NAME "twx_tree_remove(4)" ID remove )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
...
twx_test_unit_will_begin ( NAME "twx_tree_remove(5)" ID remove )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
...
twx_test_unit_will_begin ( NAME "twx_tree_expose/0" ID expose/0 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
...
twx_test_unit_will_begin ( NAME "twx_tree_expose/1" ID expose/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k/kk=v )
...
twx_test_unit_will_begin ( NAME "list support" ID list )
if ( TWX_TEST_UNIT_RUN )
  block ()
  message ( STATUS "1)************************************" )
  twx_tree_set ( "k=a;b" )
