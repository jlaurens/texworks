...
# ANCHOR: assert_key
twx_test_unit_will_begin ( ID assert_key )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_fatal_test ()
...
# ANCHOR: init/1
twx_test_unit_will_begin ( ID init/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  unset ( A/ )
  twx_tree_init ( A/ )
...
# ANCHOR: init/2
twx_test_unit_will_begin ( ID init/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  set ( A/ dummy )
  twx_tree_init ( A/ )
...
# ANCHOR: get_keys/1
twx_test_unit_will_begin ( ID get_keys/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
# ANCHOR: get/0
twx_test_unit_will_begin ( ID get/0 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  set ( v dummy )
...
# ANCHOR: get/1
twx_test_unit_will_begin ( ID get/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_fatal_test ()
  twx_tree_assert ( A/ )
...
# ANCHOR: get/2
twx_test_unit_will_begin ( ID get/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  unset ( A/ )
  twx_tree_init ( A/ )
...
# ANCHOR: set/0
twx_test_unit_will_begin ( ID set/0 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
...
# ANCHOR: set/1
twx_test_unit_will_begin ( ID set/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  unset ( A/ )
  twx_tree_init ( A/ )
...
# ANCHOR: set/2
twx_test_unit_will_begin ( ID set/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  unset ( A/ )
  twx_tree_init ( A/ )
...
# ANCHOR: set/remove/1
twx_test_unit_will_begin ( ID set/remove/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key=value )
...
# ANCHOR: set/3
twx_test_unit_will_begin ( ID set/3 )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
# ANCHOR: set/4
twx_test_unit_will_begin ( ID set/4 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key=value )
...
# ANCHOR: set/get/1
twx_test_unit_will_begin ( ID set/get/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key=value )
...
# ANCHOR: set/get/2
twx_test_unit_will_begin ( ID set/get/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
...
# ANCHOR: set/get/3
twx_test_unit_will_begin ( ID set/get/3 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ k/kk/kkk=value )
...
# ANCHOR: remove/1
twx_test_unit_will_begin ( ID "remove/1" )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
# ANCHOR: remove/2
twx_test_unit_will_begin ( ID "remove/2" )
if ( TWX_TEST_UNIT_RUN )
  block ()
  # Remove value
  twx_tree_init ( A/ )
...
# ANCHOR: remove/3
twx_test_unit_will_begin ( ID remove/3 )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
# ANCHOR: remove/4
twx_test_unit_will_begin ( ID remove/4 )
if ( TWX_TEST_UNIT_RUN )
  block ()
...
# ANCHOR: remove/5
twx_test_unit_will_begin ( ID remove/5 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ( A/ )
  twx_tree_set ( TREE A/ key/key/key=value )
...
# ANCHOR: remove(0)
twx_test_unit_will_begin ( ID "remove(0)" )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
...
# ANCHOR: TWX_TREE
twx_test_unit_will_begin ( NAME "Tree with default tyree" ID TWX_TREE )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_get ( IN_VAR v KEY k )
...
# ANCHOR: expose/0
twx_test_unit_will_begin ( ID expose/0 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
...
# ANCHOR: expose/1
twx_test_unit_will_begin ( ID expose/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k/kk=v )
...
# ANCHOR: expose/2
twx_test_unit_will_begin ( ID expose/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_tree_init ()
  twx_tree_set ( k=v )
