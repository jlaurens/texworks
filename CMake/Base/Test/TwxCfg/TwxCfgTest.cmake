...
message ( STATUS "twx_cfg_read(1)" )
block ()
list ( APPEND CMAKE_MESSAGE_CONTEXT "read(1)" )
twx_fatal_assert_passed ()
if ( TRUE )
...
message ( STATUS "twx_cfg_read(ONLY_CONFIGURE)" )
block ()
list ( APPEND CMAKE_MESSAGE_CONTEXT "read(ONLY_CONFIGURE)" )
twx_fatal_assert_passed ()
if ( TRUE )
...
message ( STATUS "twx_cfg_read(NO_PRIVATE)" )
block ()
list ( APPEND CMAKE_MESSAGE_CONTEXT "read(NO_PRIVATE)" )
twx_fatal_assert_passed ()
if ( TRUE )
...
message ( STATUS "twx_cfg_write(1)" )
block ()
list ( APPEND CMAKE_MESSAGE_CONTEXT "write(1)" )
twx_fatal_assert_passed ()
if ( TRUE )
  twx_cfg_path ( ID "write" IN_VAR where )
...
message ( STATUS "twx_cfg_write(2)" )
block ()
list ( APPEND CMAKE_MESSAGE_CONTEXT "write(2)" )
twx_fatal_assert_passed ()
if ( TRUE )
  twx_assert_undefined ( TWX_CFG_TEST_KEY_1 )
  twx_assert_undefined ( TWX_CFG_TEST_KEY_2 )
...
message ( STATUS "twx_cfg_write(3)" )
block ()
list ( APPEND CMAKE_MESSAGE_CONTEXT "write(3)" )
twx_fatal_assert_passed ()
if ( TRUE )
  twx_cfg_path ( ID "write" IN_VAR where )
  twx_cfg_write_begin ( ID "write" )
