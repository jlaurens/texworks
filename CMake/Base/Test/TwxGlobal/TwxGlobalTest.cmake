...
twx_test_unit_will_begin ( NAME "twx_global_save/restore" ID save/restore )
...
twx_test_unit_will_begin ( NAME "twx_global_set/1" ID set/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  set ( tree/ "dummy" )
...
twx_test_unit_will_begin ( NAME "twx_global_get/0" ID get/0 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  set ( A/k dummy )
...
twx_test_unit_will_begin ( NAME "twx_global_get/1" ID set/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  twx_global_restore ( IN_TREE tree/ )
...
twx_test_unit_will_begin ( NAME "twx_global_remove/0" ID remove/0 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  twx_global_set ( k=v )
...
twx_test_unit_will_begin ( NAME "twx_global_set/remove/1" ID set/remove/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  twx_global_set ( key=value )
...
twx_test_unit_will_begin ( NAME "twx_global_set/2" ID set/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
...
twx_test_unit_will_begin ( NAME "twx_global_set/3" ID set/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  twx_global_set ( key=value )
...
twx_test_unit_will_begin ( NAME "twx_global_set/get/0" ID TWX_TREE )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  set ( A/k "dummy" )
...
twx_test_unit_will_begin ( NAME "twx_global_set/get/1" ID set/get/1 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  twx_global_set ( key=value )
...
twx_test_unit_will_begin ( NAME "twx_global_set/get/2" ID set/get/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
...
twx_test_unit_will_begin ( NAME "twx_global_remove/1" ID set/2 )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
...
twx_test_unit_will_begin ( NAME "twx_global_remove/2" )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  twx_global_set ( key=value )
...
twx_test_unit_will_begin ( NAME "twx_global_remove/3" )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
...
twx_test_unit_will_begin ( NAME "twx_global_remove/4" )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
  twx_global_set ( key/key/key=value )
...
twx_test_unit_will_begin ( NAME "twx_global_..." ID ... )
if ( TWX_TEST_UNIT_RUN )
  block ()
  twx_global_clear ()
