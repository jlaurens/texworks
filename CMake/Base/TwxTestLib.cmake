...
function ( twx_test_case )
  ...
  cmake_parse_arguments ( PARSE_ARGV 0 twxR "" "IN_VAR;TARGET" "" )
  if ( NOT "${twxR_UNPARSED_ARGUMENTS}" STREQUAL "" )
    message ( FATAL_ERROR "Too many arguments: \"${twxR_UNPARSED_ARGUMENTS}\"" )
  endif ()
  if ( NOT TARGET "${twxR_TARGET}" )
    message ( FATAL_ERROR "Unknown target \"${twxR_TARGET}\"" )
  endif ()
  if ( NOT "${twxR_IN_VAR}" MATCHES "[^ ]" )
    message ( FATAL_ERROR "Bad variable name \"${twxR_IN_VAR}\"" )
  endif ()
  ...
  # Remove this branch when done
    ...
    file (
      REMOVE_RECURSE "${${twxR_IN_VAR}}"
    )
    twx_message ( VERBOSE "twx_test_case DESTINATION: ${${twxR_IN_VAR}}" )
    file (
      RENAME
