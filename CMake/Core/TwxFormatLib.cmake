...
function ( twx_format_parse_color )
  ...
  list ( POP_FRONT twx_format_parse_color.R_UNPARSED_ARGUMENTS twx_format_parse_color.COLOR )
  if ( NOT twx_format_parse_color.R_UNPARSED_ARGUMENTS STREQUAL "" )
    message ( FATAL_ERROR " Bad usage: ``twx_format_parse_color.R_UNPARSED_ARGUMENTS => ${twx_format_parse_color.R_UNPARSED_ARGUMENTS}''" )
  endif ()
  ...
  string ( TOLOWER "${twx_format_parse_color.COLOR}" twx_format_parse_color.COLOR )
  if ( "${twx_format_parse_color.COLOR}" MATCHES "^([0-9]+)/([0-9]+)/([0-9]+)$" )
    # Under development
    if ( NOT TWX_FORMAT_24 )
      return ()
    elseif ( twx_format_parse_color.R_BACK )
      list ( APPEND twx_format_parse_color.PREFIX "48" "2" )
    else ()
      list ( APPEND twx_format_parse_color.PREFIX "38" "2" )
    endif ()
    foreach ( i 1 2 3 )
      ...
      if ( RGB_${i} LESS "256" )
        ...
        twx_format_warning ( "Unsupported text color ``${twx_format_parse_color.COLOR}''" )
        list ( APPEND twx_format_parse_color.PREFIX "255" )
      endif ()
    endforeach ()
  elseif ( "${twx_format_parse_color.COLOR}" MATCHES "^([0-9]+)$" )
    ...
    if ( CMAKE_MATCH_1 LESS "256" )
      list ( APPEND twx_format_parse_color.PREFIX "${CMAKE_MATCH_1}" )
    else ()
      twx_format_warning ( "Unsupported text color ``${twx_format_parse_color.COLOR}''" )
      list ( APPEND twx_format_parse_color.PREFIX "255" )
    endif ()
  else ()
    if ( "${twx_format_parse_color.COLOR}" MATCHES "^bright (.*)$" )
      set ( twx_format_parse_color.COLOR "${CMAKE_MATCH_1}" )
      set ( bright_ ON )
    else ()
      set ( bright_ OFF )
    endif ()
    set ( colors_ black red green yellow blue magenta cyan white )
    list ( FIND colors_ "${twx_format_parse_color.COLOR}" i )
    message ( DEBUG "i => ${i}" )
    if ( i LESS 0 )
      twx_format_warning ( "Unsupported text color ``${twx_format_parse_color.COLOR}''" )
      set ( i 1 )
