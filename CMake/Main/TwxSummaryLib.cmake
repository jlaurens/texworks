...
if ( WIN32 OR TWX_SUMMARY_NO_COLOR )
  ...
  set ( /TWX/FORMAT.reset "${TWX_SUMMARY_CHAR_ESCAPE}[m" )
...
macro ( twx_summary__parse_arguments )
  ...
  twx_message_mode_index ( STATUS IN_VAR log_level_status_ )
  ...
  twx_message_mode_index ( ${log_level_} IN_VAR log_level_ )
...
function ( twx_summary__common_ancestor )
  ...
  while ( "${ref_}" MATCHES "^([^/]*/)(.+)$" )
    ...
    set ( new_ )
    foreach ( full_ IN LISTS twx.R_UNPARSED_ARGUMENTS )
...
function ( twx_summary_section_git )
  ...
  twx_summary_log ( "Hash"    "${/TWX/CFG/GIT_HASH}" )
  twx_summary_log ( "Date"    "${/TWX/CFG/GIT_DATE}" )
  twx_summary_log ( "Branch"  "${/TWX/CFG/GIT_BRANCH}" )
  twx_summary_end ()
endfunction ()
