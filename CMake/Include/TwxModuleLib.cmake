...
function ( twx_module_configure )
  ...
  if ( NOT "${${module_}_MODULES}" STREQUAL "")
...
function ( twx_module_ui_dir dir_ )
  ...
  if ( NOT EXISTS "${${dir_}}" )
    twx_fatal ( "No module named ${my_twx_MODULE}" )
  endif ()
  twx_export ( ${dir_} )
endfunction ()
