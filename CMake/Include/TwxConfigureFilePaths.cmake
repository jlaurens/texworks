...
# Guard
include ( TwxInfoLib )
twx_info_return_if_exists ( "paths" )
...
if (WIN32)
	twx_info_set ( PATH_LIST_SEPARATOR ";" )
else ()
	twx_info_set ( PATH_LIST_SEPARATOR ":" )
endif ()
...
if ( "${TWX_TEST_PATHS}" STREQUAL "" )
  twx_info_set ( FACTORY_BINARY_PATHS "${TWX_paths}" )
  twx_info_set ( FACTORY_BINARY_PATHS_TEST "" )
else()
  twx_info_set ( FACTORY_BINARY_PATHS "${TWX_TEST_PATHS}" )
  twx_info_set ( FACTORY_BINARY_PATHS_TEST "${TWX_paths}" )
endif ()

twx_info_write_end ( "paths" )
