...
if ( "${TWX_TEST_PATHS}" STREQUAL "" )
  twx_info_set ( STATIC_BINARY_PATHS "${TWX_paths}" )
  twx_info_set ( STATIC_BINARY_PATHS_TEST "" )
else()
  twx_info_set ( STATIC_BINARY_PATHS "${TWX_TEST_PATHS}" )
  twx_info_set ( STATIC_BINARY_PATHS_TEST "${TWX_paths}" )
endif ()
